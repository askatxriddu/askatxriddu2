...
def Valobasa():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/askatxriddu/askatxriddu2/blob/main/askat.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Bristy()
		...
		print(logo)
		print ("")
		print(" \033[1;32m ┏━ RANDOM CLONING TOLL FREE BUT YOU NEED GET APPROVED FIRST\033[1;37m\n")
		print(" \033[1;32m ┗━ IF YOU DON'T GIVE A REVIEW, YOU WON'T GET APPROVAL AFTER THAT  \033[1;37m")
		print ("")
		...
		os.system('am start https://www.facebook.com/profile.php?id=100091256138777?text=' + tks)
		Valobasa()        
Valobasa()
